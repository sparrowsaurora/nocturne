...
a main menu where you can select playlists > songs
...
i should be able to pause/play and skip to different points in the song (minimum via increment skips (e.g 10s fast forward))
